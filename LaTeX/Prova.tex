...
\begin{document}
	...
	Il segnale in uscita al circuito controllato in corrente, con il generatore di corrente del modello equivalente del SiPM impostato per dare un'ampiezza pari alle particelle alpha è la seguente:
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{vout2_controllo_corrente.PNG}
		\caption{Segnale in uscita al circuito \gls{sipm} controllato in corrente}
		\label{fig:sipm}
	\end{figure}
	
	Lo stesso impulso confrontato con il circuito controllato in tensione sia con 8 che 16 celle connese al \gls{sipm}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[t]{0.48\textwidth} % Cambiato in [t]
			\centering
			\includegraphics[width=\linewidth]{confronto_currentmode_voltagemode_8_SiPM.png}
		...
		\begin{subfigure}[t]{0.48\textwidth} % Cambiato in [t]
			\centering
			\includegraphics[width=\linewidth]{confronto_currentmode_voltagemode_16_SiPM.png}
	...
	2.7us fall time controllo corrente contro i circa 40 del controllo in tensione
